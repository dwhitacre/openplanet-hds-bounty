...
[Setting category="Birthday Display" name="Rainbow Color" hidden]
vec3 S_Birthday_RainbowColor = vec3(1, 0, 0);

[Setting category="Birthday Display" name="Rainbow Interval" min=0.f max=.03f description="Step interval for rainbow effect. Smaller numbers mean slower transitions."]
...
[Setting category="Birthday Display" name="Show Countdown" description="Disable to hide the countdown manually. Simulates the timer being at 0." hidden]
...
[Setting category="Birthday Display" name="Goal Player Label"]
string S_Birthday_GoalPlayerLabel = "Goal";

[Setting category="Birthday Display" name="Goal Player Rainbow"]
bool S_Birthday_GoalPlayerRainbow = false;

[Setting category="Birthday Display" color name="Goal Player Label Color"]
vec3 S_Birthday_GoalPlayerLabelColor = vec3(1, 1, 1);

[Setting category="Birthday Display" color name="Goal Player Name Color"]
vec3 S_Birthday_GoalPlayerNameColor = vec3(1, 1, 1);

[Setting category="Birthday Display" color name="Goal Player Score Color"]
vec3 S_Birthday_GoalPlayerScoreColor = vec3(1, 1, 1);

[Setting category="Birthday Display" name="Current Player Label"]
string S_Birthday_CurrentPlayerLabel = "PB";

[Setting category="Birthday Display" name="Current Player Rainbow"]
bool S_Birthday_CurrentPlayerRainbow = false;

[Setting category="Birthday Display" color name="Current Player Label Color"]
vec3 S_Birthday_CurrentPlayerLabelColor = vec3(1, 1, 1);

[Setting category="Birthday Display" color name="Current Player Name Color"]
vec3 S_Birthday_CurrentPlayerNameColor = vec3(1, 1, 1);

[Setting category="Birthday Display" color name="Current Player Score Color"]
vec3 S_Birthday_CurrentPlayerScoreColor = vec3(1, 1, 1);

[Setting category="Birthday Display" name="Top Player Label"]
string S_Birthday_TopPlayerLabel = "WR";

[Setting category="Birthday Display" name="Top Player Rainbow"]
bool S_Birthday_TopPlayerRainbow = false;

[Setting category="Birthday Display" color name="Top Player Label Color"]
vec3 S_Birthday_TopPlayerLabelColor = vec3(1, 1, 1);

[Setting category="Birthday Display" color name="Top Player Name Color"]
vec3 S_Birthday_TopPlayerNameColor = vec3(1, 1, 1);

[Setting category="Birthday Display" color name="Top Player Score Color"]
